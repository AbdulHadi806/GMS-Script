    ...
    with sync_playwright() as p:
        ...
        for search_for_index, search_for in enumerate(search_list):
            ...
            #########
                ...
                business_list.save_to_excel(f"google_maps_data_{search_for}".replace('\\', '_').replace('/', '_').replace(':', '_'))
                business_list.save_to_csv(f"google_maps_data_{search_for}".replace('\\', '_').replace('/', '_').replace(':', '_'))
            except Exception as e:
                print(f'Error occured: {e}')
        browser.close()
